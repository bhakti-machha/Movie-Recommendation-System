...
def get_movie_info(imdb_link):
    ...
    #rating = s_data.find("div", class_="AggregateRatingButton__TotalRatingAmount-sc-1ll29m0-3 bhaktimachha")
    #rating = str(rating).split('<div class="AggregateRatingButton__TotalRatingAmount-sc-1ll29m0-3 bhaktimachha')
...
def run():
   ...
   # st.image(img1,use_column_width=False)
    ...
    st.markdown('''<h6 style='text-align: left; color: #d73b5c;'></h6>''',
...
def set_bg_hack_url():
    ...
    st.markdown(
        f"""
         <style>
         .stApp {{
             background: url("https://png.pngtree.com/thumb_back/fw800/back_our/20190621/ourmid/pngtree-steam-wave-international-film-festival-banner-poster-image_195212.jpg");
